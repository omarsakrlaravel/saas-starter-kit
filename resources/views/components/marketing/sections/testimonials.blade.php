<section class="w-full">
    <x-marketing.elements.heading level="h2" title="Oceans of Approval" description="Find out why users are on board, through their own words and success tales." />
    <ul role="list" class="grid grid-cols-1 gap-12 py-12 mx-auto max-w-2xl lg:max-w-none lg:grid-cols-3">
            ...
            <figure class="flex flex-col justify-between h-full">
                <blockquote class="">
                    <p class="text-sm sm:text-base font-medium text-zinc-500">
                        The ready-to-use features sped up our launch significantly. The authentication and subscription tools are particularly impressive and user-friendly.
                    </p>
                </blockquote>
        ...
        <li>
            <figure class="flex flex-col justify-between h-full">
                <blockquote class="">
                    <p class="text-sm sm:text-base font-medium text-zinc-500">
                        This transformed our development workflow with its excellent API and profile management, saving us valuable time.
                    </p>
                </blockquote>
                <figcaption class="flex flex-col justify-between mt-6">
        ...
        <li>
            <figure class="flex flex-col justify-between h-full">
                <blockquote class="">
                    <p class="text-sm sm:text-base font-medium text-zinc-500">
                        An amazing SaaS starter kit. The team here leverages it all the time for many projects.
                    </p>
                </blockquote>
                <figcaption class="flex flex-col justify-between mt-6">
