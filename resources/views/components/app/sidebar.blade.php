<div x-data="{ sidebarOpen: false }"  @open-sidebar.window="sidebarOpen = true"
    ...
    <div :class="{ '-translate-x-full': !sidebarOpen }"
        class="fixed top-0 left-0 flex items-stretch -translate-x-full overflow-hidden lg:translate-x-0 z-50 h-dvh md:h-screen transition-[width,transform] duration-150 ease-out bg-zinc-50 dark:bg-zinc-900 w-64 group @if(config('saas.dev_bar')){{ 'pb-10' }}@endif">  
