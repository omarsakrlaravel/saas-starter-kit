        ...
        @else
            ...
            <div class="flex flex-col justify-center items-center w-screen h-screen">
                ...
                <div class="flex flex-col items-center p-10 mx-auto mt-8 w-full max-w-lg bg-white rounded-2xl border shadow-sm border-zinc-100">
                    <h1 class="text-2xl font-semibold text-black">Welcome</h1>
                    <p class="mt-5 text-zinc-500">If you're ready to get started, click on the 'Install' button below. In the future this installation screen will have a few setup options.</p>
                    <a href="/install?complete=true" class="flex justify-center px-4 py-2 mt-8 w-full text-lg font-medium text-white bg-gray-900 rounded-md border border-transparent transition duration-150 ease-in-out hover:bg-gray-800 focus:outline-none focus:border-gray-900 active:bg-gray-900">
                        Install
                    </a>
                </div>
            </div>
