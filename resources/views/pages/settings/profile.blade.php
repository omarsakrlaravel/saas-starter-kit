				...
				<div class="relative flex flex-col mt-5 lg:px-10">
					<div class="relative flex-shrink-0 w-32 h-32 cursor-pointer group">
						...
						<div class="absolute inset-0 w-full h-full">
							...
							<button class="absolute inset-0 z-10 flex items-center justify-center w-full h-full rounded-full bg-black/50 opacity-0 transition-opacity group-hover:opacity-100">
				...
				<x-filament::modal id="profile-avatar-crop">
					...
					<div class="mt-5 sm:mt-6">
						<span class="flex w-full rounded-md shadow-sm">
							...
							<button @click="window.dispatchEvent(new CustomEvent('close-modal', { detail: { id: 'profile-avatar-crop' }})); applyImageCrop()" class="inline-flex justify-center w-full px-4 py-2 ml-2 text-base font-medium leading-6 text-white transition duration-150 ease-in-out bg-blue-600 border border-transparent rounded-md shadow-sm hover:bg-blue-500 focus:outline-none focus:border-blue-700 focus:shadow-outline-primary sm:text-sm sm:leading-5" id="apply-crop" type="button">Apply</button>
						</span>
					</div>
				</x-filament::modal>
			</div>
