                    ...
                    <div class="flex items-start justify-between">
                        ...
                        <div class="text-right">
                            <div class="flex items-baseline gap-0.5">
                                <span class="text-2xl font-bold tracking-tight text-zinc-900 dark:text-zinc-100">${{ $this->unitPrice }}</span>
                                <span class="text-sm text-zinc-400 dark:text-zinc-500">/{{ $billing_cycle === 'month' ? 'mo' : 'yr' }}</span>
                            </div>
                            @if($this->effectiveMonthlyPrice)
                                <p class="mt-0.5 text-xs text-zinc-400 dark:text-zinc-500">${{ $this->effectiveMonthlyPrice }}/mo billed yearly</p>
                            @endif
                        </div>
                    </div>
                    ...
                    @if($this->yearlySavings)
                        <div class="mt-4 flex items-center gap-2 rounded-lg border border-blue-200 bg-blue-50 px-3.5 py-2.5 dark:border-blue-800/40 dark:bg-blue-950/30">
                            ...
                            <p class="text-sm text-blue-700 dark:text-blue-300">
                                You save <span class="font-semibold">${{ number_format($this->yearlySavings * $seat_quantity, 0) }}/yr</span> compared to monthly billing.
                            </p>
                        </div>
                    @endif
                </div>
                ...
                <div class="px-5 py-4">
                    <div class="space-y-3">
                        ...
                        <div class="flex items-center justify-between text-sm">
                            ...
                            <span class="font-medium text-zinc-900 dark:text-zinc-100">${{ $this->unitPrice }}</span>
                        </div>
                    ...
                    @if((int) $plan->trial_days > 0)
                        <div class="space-y-2.5">
                            <div class="flex items-center justify-between">
                                ...
                                <span class="text-xl font-bold text-emerald-600 dark:text-emerald-400">$0.00</span>
                            </div>
                            <div class="flex items-center justify-between">
                                ...
                                <span class="text-sm font-medium text-zinc-700 dark:text-zinc-300">
                                    ${{ number_format($this->totalPrice, 2) }}/{{ $billing_cycle === 'month' ? 'mo' : 'yr' }}
                                </span>
                            </div>
                        </div>
                    @else
                        <div class="flex items-center justify-between">
                            ...
                            <div class="text-right">
                                <span class="text-xl font-bold text-zinc-900 dark:text-zinc-100">${{ number_format($this->totalPrice, 2) }}</span>
